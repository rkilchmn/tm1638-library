...
const byte CA_LOGIC = 8; // comman anode display works only with exact 8 digits
...
public:
  ...
  /** Set the display to the String (defaults to built in font) - pos is ignored in common anode
     *  dots LSB (bit index 0) is leftmost digit, MSB (bit 7) is rigthmost digit
     */
